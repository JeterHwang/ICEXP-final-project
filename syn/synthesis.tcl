# Read Design
read_file -format verilog ../src/SMVM.v
...
report_area > area_SMVM.out
report_power > power_SMVM.out
report_timing -path full -delay max > timing_SMVM.out

#write -format db -hierarchy -output $active_design.db
write -format verilog -hierarchy -output SMVM_syn.v
write_sdf -version 2.1 -context verilog SMVM_syn.sdf
write_sdc SMVM_syn.sdc
